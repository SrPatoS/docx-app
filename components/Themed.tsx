...
type ThemeProps = {
	lightColor?: string;
	darkColor?: string;
	setPrimaryBackgroundColor?: boolean
};
...
export function StatusBarThemed(props: ThemeProps) {
	...
	return (
		<View style={{ marginBottom: Platform.OS === "android" ? RNStatusBar.currentHeight : 0 }}>
			<StatusBar style={themeUsed} backgroundColor={backgroundColor} />
		</View>
	);
}